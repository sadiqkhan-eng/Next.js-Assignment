    ...
    <div className="relative isolate px-6 pt-14 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 text-center">
        ...
        <p className="mt-6 text-lg leading-8 text-gray-600">
          Explore a curated collection of high-quality electronics, apparel, and accessories. Find exactly what you need with ease.
        </p>
        <div className="mt-10 flex items-center justify-center gap-x-6">
          ...
          <Link href="/about" className="text-sm font-semibold leading-6 text-gray-900 hover:text-indigo-600 transition-colors duration-300">
